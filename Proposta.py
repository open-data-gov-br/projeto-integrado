...
class Proposta:
    def __init__(self, id_proposta, codigo, titulo, sub_titulo, data_hora, paragrafos, quantidade_de_votos_publicos, votos_dos_deputados, indicacao_de_votos_dos_partidos):
